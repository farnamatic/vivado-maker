...
##################################################################################################################################################################
##   U55C - Master XDC
##	 Revision 0.03 - Intial Release for U55
##	 Revision 1.00 - Name changed to U55C,SYSCLK4_N Pin added ,	NS GTY signal removed.
##################################################################################################################################################################
##   Key Notes:
...
##                                                  |
##                                                  |-> OUT0  SYSCLK4_P/SYSCLK4_N 100.000Mhz - onboard SYSCLK4 Clock
##                                                  |   PINS: IO_L11P_T1U_N8_GC_72_F24/IO_L11N_T1U_N9_GC_72_F23
##                                                  |
...
##                             	 |
##                             	 |-> OUT2  PCIE_CLK1_P/PCIE_CLK1_N 100.000Mhz - PCIe REFCLK0 for x16 and Bifrucated x8 Lanes 8-15 synchronous Clocking
...
set_property IOSTANDARD  LVDS 	  [get_ports "SYSCLK4_N"] ;# Bank  72 VCCO - VCC1V8   - IO_L11N_T1U_N9_GC_72_F23
set_property PACKAGE_PIN F24     [get_ports "SYSCLK4_P"] ;# Bank  72 VCCO - VCC1V8   - IO_L11P_T1U_N8_GC_72_F24
set_property IOSTANDARD  LVDS 	  [get_ports "SYSCLK4_P"] ;# Bank  72 VCCO - VCC1V8   - IO_L11P_T1U_N8_GC_72_F24                 
...
create_clock -period 10.000 -name SYSCLK4         [get_ports "SYSCLK4_P"]
